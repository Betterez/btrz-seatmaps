...
// 👇️ named export
var SeatmapEvents = require("./seatmap-events.js");
    ...
    value: function draw() {
      ...
      if (container) {
        ...
        [].concat(_toConsumableArray(this.corridor), _toConsumableArray(this.facilities), _toConsumableArray(this.seats)).forEach(function (elem) {
          var classes = _classPrivateMethodGet(_this, _getElementClasses, _getElementClasses2).call(_this, elem);
          var e = _classPrivateMethodGet(_this, _createHTMLElement, _createHTMLElement2).call(_this, "div", classes, elem.label || "");
...
function _updateFacilities2() {
  ...
  this.facilities.forEach(function (ele) {
    if (ele.type === "driver") {
      ...
      ele.width = _this2.availableCols;
      ele.row = ele.position.key === _class.FACILITY_POSITION.Top ? 1 : _this2.availableRows;
      filteredElements.push(ele);
    } else if (ele.type === "door") {
      ele.col = ele.alignment.key === _class.FACILITY_ALIGNMENT.Left ? 1 : _this2.availableCols;
      filteredElements.push(ele);
...
function _buildCorridor2() {
  ...
  rows.forEach(function (row, rIndex) {
    ...
    _this3.corridor.push({
      ...
      width: 1,
      type: "corridor",
      classes: _this3.classes.corridor,
...
function _buildSeats2() {
  ...
  rows.forEach(function (row, rIndex) {
    cols.forEach(function (col, cIndex) {
      var overlaps = _classPrivateMethodGet(_this4, _overlapsWithFixedElement, _overlapsWithFixedElement2).call(_this4, [].concat(_toConsumableArray(_this4.facilities), _toConsumableArray(_this4.corridor)), rIndex + 1, cIndex + 1);
      ...
      if (!hideSeat) {
        ...
        var customSeat = _this4.customSeats.find(function (st) {
