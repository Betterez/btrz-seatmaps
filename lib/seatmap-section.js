...
var _showNumPad = /*#__PURE__*/new WeakSet();
...
var SeatmapSection = /*#__PURE__*/function () {
  function SeatmapSection() {
    ...
    _classPrivateMethodInitSpec(this, _showNumPad);
  ...
  _createClass(SeatmapSection, [{
    ...
    value: function draw() {
      var _this25 = this;
      var numericDisplay = _classPrivateMethodGet(this, _createHTMLElement, _createHTMLElement2).call(this, "div", "numeric-display, absolute, right-0, left-0, text-center, z-[2], font-weight-bolder, opacity-20, text-color-primary");
      ...
      if (container) {
        ...
        if (this.sectionName && this.showSectionName) {
          var sectionNameWrapper = _classPrivateMethodGet(this, _createHTMLElement, _createHTMLElement2).call(this, "div", "absolute, bottom-0, right-0, left-0, text-center, -mb-200, z-[2]");
          var sectionNameContainer = _classPrivateMethodGet(this, _createHTMLElement, _createHTMLElement2).call(this, "div", "bg-bz-info-default, uppercase, text-size-87, text-bz-info-lightest, shadow-elevation-flat, border, border-bz-info-light, inline-block, rounded-pill, px-100, leading-175", this.sectionName);
        ...
        [].concat(_toConsumableArray(this.corridor), _toConsumableArray(this.facilities), _toConsumableArray(this.seats)).forEach(function (elem) {
          ...
          var label = _classPrivateMethodGet(_this25, _createHTMLElement, _createHTMLElement2).call(_this25, "div", "", elem.label || "");
          var e = _classPrivateMethodGet(_this25, _createHTMLElement, _createHTMLElement2).call(_this25, "div", classes, label.outerHTML);
  ...
  rows.forEach(function (row, rIndex) {
    cols.forEach(function (col, cIndex) {
      ...
      if (!hideSeat) {
        ...
        if (_this30.allowSeatOrientation) {
  ...
  if (evt.keyCode >= 48 && evt.keyCode <= 57 || evt.keyCode >= 96 && evt.keyCode <= 105) {
    if (this.numPad === "") {
      setTimeout(function () {
        ...
        _this32.numPad = "";
        _classPrivateMethodGet(_this32, _showNumPad, _showNumPad2).call(_this32, _this32.numPad);
      }, "500");
    }
    this.numPad += evt.key;
    _classPrivateMethodGet(this, _showNumPad, _showNumPad2).call(this, this.numPad);
    evt.stopPropagation();
    evt.preventDefault();
  }
}
