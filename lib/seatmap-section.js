...
function _getElementClasses2(elem) {
  if (elem.type === "table") {
    return _class.CLASSES.table;
  }
  if (elem.type === "wc") {
    return _class.CLASSES.wc;
  }
  if (elem.type === "item") {
    return _class.CLASSES.item;
  }
  if (elem.type === "gap") {
    return _class.CLASSES.gap;
  }
  if (elem.type === "driver") {
    return elem.alignment.key === _class.FACILITY_ALIGNMENT.Left ? _class.CLASSES.driverLeft : _class.CLASSES.driverRight;
  }
  if (elem.type === "door") {
    return elem.alignment.key === _class.FACILITY_ALIGNMENT.Left ? _class.CLASSES.doorLeft : _class.CLASSES.doorRight;
  }
  if (elem.type === "stairway") {
    return elem.orientation.key === _class.FACILITY_ORIENTATION.Horizontal ? _class.CLASSES.stairwayHorizontal : _class.CLASSES.stairwayVertical;
  }
  if (elem.type === "accordion") {
    return elem.position.key === _class.FACILITY_POSITION.Bottom ? _class.CLASSES.accordionBottom : _class.CLASSES.accordionTop;
  }
  return elem.classes || "";
}
