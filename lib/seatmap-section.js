  ...
  rows.forEach(function (row, rIndex) {
    cols.forEach(function (col, cIndex) {
      ...
      if (!hideSeat) {
        ...
        var allowKeyNav = ["selected", "available", "accessible", "blocked", "reserved"].includes(customSeat ? customSeat.status : "available") && (!overlaps.length || overlapsItem) ? true : false;
