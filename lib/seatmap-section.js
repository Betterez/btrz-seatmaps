...
var SeatmapSection = /*#__PURE__*/function () {
  ...
  _createClass(SeatmapSection, [{
    ...
    value: function focusOnNextSelected(seat) {
      var seatSelected = seat ? document.querySelector("[data-keynav='true'][data-selected=true][data-index='".concat(seat.index, "']")) : document.querySelector("[data-keynav='true'][data-selected=true]");
    ...
    value: function changeSeatDataProp(elem, prop, value) {
      ...
      var selector = "".concat(sectionSelector, "[style*='grid-area: ").concat(elem.row, " / ").concat(elem.col, " / ").concat(parseInt(elem.row, 10) + (elem.height || 1), " / ").concat(parseInt(elem.col, 10) + (elem.width || 1), ";']");
      var element = document.querySelector(selector);
      if (element) {
