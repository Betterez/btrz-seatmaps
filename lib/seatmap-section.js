...
var SeatmapSection = /*#__PURE__*/function () {
  ...
  _createClass(SeatmapSection, [{
    ...
    value: function draw() {
      var _this25 = this;
      var numericDisplay = _classPrivateMethodGet(this, _createHTMLElement, _createHTMLElement2).call(this, "div", "numeric-display, absolute, right-0, left-0, center, z2, bold, opacity3, color-grey-darkest");
    ...
    cols.forEach(function (col, cIndex) {
      ...
      if (!hideSeat) {
        ...
        if (status === "reserved" && !_this30.isEditing) {
          status = _this30.isBackOffice ? "available" : "blocked";
        }
        var seat = {
