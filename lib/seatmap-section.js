...
var SeatmapEvents = /*#__PURE__*/function () {
  function SeatmapEvents(settings) {
    ...
    this.channel.on("seat:unselected", function (seat) {
      var unselectedSeat = seat.selected_seat.seat_id;
      ...
      if (settings.socketEvents) {
        ...
        this.events = [{
          ...
          cb: function cb(evt, e, elem, seatmapEvents) {
            ...
            if (seatmapEvents.callbacks.seatSelected(elem, {
  ...
  rows.forEach(function (row, rIndex) {
    cols.forEach(function (col, cIndex) {
      ...
      if (!hideSeat) {
        ...
        var allowKeyNav = ["selected", "available", "blocked", "reserved"].includes(customSeat ? customSeat.status : "available") && (!overlaps.length || overlapsItem) ? true : false;
